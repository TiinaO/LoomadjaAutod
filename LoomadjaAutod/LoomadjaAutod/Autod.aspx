<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Autod.aspx.cs" Inherits="LoomadjaAutod.Autod" %>
...
<body>
    ...
    <h1>Autod</h1>
        ...
        <asp:GridView ID="GridView1" runat="server" AllowSorting="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" DataKeyNames="registrinumber" DataSourceID="SqlDataSource1" EmptyDataText="There are no data records to display." ForeColor="Black" GridLines="Horizontal">
            <Columns>
        ...
        <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" BackColor="White" BorderColor="Silver" BorderWidth="1px" CellPadding="3" DataKeyNames="registrinumber" DataSourceID="SqlDataSource1" DefaultMode="Insert" GridLines="Horizontal" Height="50px" OnPageIndexChanging="DetailsView1_PageIndexChanging" Width="125px">
